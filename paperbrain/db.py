...
""".strip(),
    ...
    "CREATE INDEX IF NOT EXISTS idx_person_cards_slug_trgm ON person_cards USING gin (slug gin_trgm_ops);",
    "CREATE INDEX IF NOT EXISTS idx_topic_cards_body_trgm ON topic_cards USING gin (body gin_trgm_ops);",
    "CREATE INDEX IF NOT EXISTS idx_topic_cards_slug_trgm ON topic_cards USING gin (slug gin_trgm_ops);",
